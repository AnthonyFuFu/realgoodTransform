...
$(function(){
	...
	*/
	...
	$('.declare, #declare,.new_declare').on('click', function(){		
		layer.alert('感謝同學報名<font color="#FF0000">TKB臺灣知識庫—大碩研究所，百官網公職，龍門轉學考，洋碩美語，甄戰學習顧問中心，數位學堂，雲端函授等課程</font>，衷心預祝您金榜題名！<p>提醒您：<br />繳費請洽櫃台或依公司指定個人專用帳號匯款，並索取發票。<br />本公司不會以電話通知【繳費入帳操作錯誤】、【分期繳費扣款錯誤】、【扣款錯誤需操作ATM退款】、【提供信用卡安全碼或扣款銀行電話】、【假冒郵局或銀行職員說晚上12點不到ATM操作會重複扣款】、【課程、教材購買套數key錯】、【依指示到超商買Gash卡並給密碼】、【大陸口音電話】等情形均為詐騙電話，若有接獲不明電話，請洽原報名單位查詢。</p>', {
		  skin: 'layui-layer-molv' //樣式類別
		  ,closeBtn: 1
		  ,title: ['TKB反詐騙宣導']
		  ,btn: ['確定']
