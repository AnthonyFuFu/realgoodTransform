...
public interface WinnerService {
	 ...
	 * @return List<Winner>
	 */
	public List<Winner> getFrontList(int pageCount, int pageStart, Winner winner, List<WinnerCategory> winnerCategoryList, String search_sort);
    ...
    */
	 ...
	 * 新增資料
	 */
	public void addSubmitFunction(Winner winner, WinnerContent winnerContent,User suer, HttpServletRequest request);
	
	/**
	 * 修改頁面
	 */
	public Map<String, Object>updateFunction (Winner winner, WinnerCategory winnerCategory, WinnerContent winnerContent);
